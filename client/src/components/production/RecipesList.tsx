...
import { ArrowLeft, ClipboardCopy, Edit, Eye, Info, Plus, Search } from 'lucide-react';
...
export default function RecipesList() {
  ...
  const handleDuplicateRecipe = (recipe: Recipe) => {
    // Create a new recipe object without ID and with "(copy)" added to the name
    const duplicatedRecipe = {
      ...recipe,
      name: `${recipe.name} (${t('production.copy')})`,
      sku: `${recipe.sku}-COPY`
    };
