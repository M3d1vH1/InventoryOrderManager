          ...
          {viewingProduct && (
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  <span className="font-medium">SKU:</span> {viewingProduct.sku} • <span className="font-medium">Category:</span> {viewingProduct.category}
                </DialogDescription>
              </DialogHeader>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <p className="mt-1">{viewingProduct.description || "No description provided"}</p>
                          </div>
                          
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <h4 className="text-sm font-medium text-slate-500">Current Stock</h4>
                            ...
                            <div>
                              <h4 className="text-sm font-medium text-slate-500">Min Stock Level</h4>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <h4 className="text-sm font-medium text-slate-500">Storage Location</h4>
                              <p className="text-slate-700">{viewingProduct.location || "Not specified"}</p>
                            </div>
                            <div>
                              <h4 className="text-sm font-medium text-slate-500">Units per Box</h4>
                              <p className="text-slate-700">{viewingProduct.unitsPerBox || "Not specified"}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <TabsContent value="barcode">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Scan or print the barcode for this product</CardDescription>
                    </CardHeader>
                    <CardContent className="flex flex-col items-center justify-center py-6">
                      {viewingProduct.barcode ? (
                        <div className="text-center">
                          ...
                          />
                          <p className="mt-4 text-sm text-slate-500">Barcode: {viewingProduct.barcode}</p>
                        </div>
                      ) : (
                        <div className="text-center py-8">
                          <QrCode className="h-16 w-16 text-slate-300 mx-auto" />
                          <p className="mt-4 text-slate-500">No barcode assigned to this product</p>
                          <Button 
                            variant="outline" 
                            className="mt-4"
                            onClick={() => {
