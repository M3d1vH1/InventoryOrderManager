  ...
  async updateNotificationSettings(settings: Partial<InsertNotificationSettings>): Promise<NotificationSettings | undefined> {
    if (!this.notificationSettingsData) {
      ...
      this.notificationSettingsData = {
        ...
        slackFinanceWebhookUrl: settings.slackFinanceWebhookUrl ?? null,
        slackNotifyNewOrders: settings.slackNotifyNewOrders ?? true,
        slackNotifyOrderPicked: (settings as any).slackNotifyOrderPicked ?? false,
        slackNotifyOrderShipped: (settings as any).slackNotifyOrderShipped ?? false,
        slackNotifyCallLogs: settings.slackNotifyCallLogs ?? true,
        slackNotifyLowStock: settings.slackNotifyLowStock ?? true,
        ...
        slackOrderPickedTemplate: (settings as any).slackOrderPickedTemplate ?? null,
        slackOrderShippedTemplate: (settings as any).slackOrderShippedTemplate ?? null,
        slackCallLogTemplate: settings.slackCallLogTemplate ?? null,
        slackLowStockTemplate: settings.slackLowStockTemplate ?? null,
        slackInvoiceTemplate: settings.slackInvoiceTemplate ?? null,
        slackPaymentTemplate: settings.slackPaymentTemplate ?? null,
        createdAt: new Date(),
        updatedAt: new Date()
      };
    } else {
